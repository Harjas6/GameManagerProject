...
public class NameComparatorTest {
    ...
    public void runBefore() {
        ...
        sportGame = new Game("FIFA 22", 48, 0,
                6, SPORT, 40, true);
        sportGame2 = new Game("FIFA 22", 45, 0,
                6, SPORT, 40, true);
    ...
    @Test
    void compareTest() {
        assertEquals(0, comp.compare(sportGame2, sportGame));
        assertEquals(2, comp.compare(openWorldGame, shootingGame));
        assertEquals(-12, comp.compare(sportGame, platformGame));
    }
